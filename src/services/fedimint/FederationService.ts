...
import { previewFederation, Wallet } from "@fedimint/core-web";
import type { FederationMeta,FederationMetaData,FederationConfig,FederationDetailResponse } from "../../hooks/Federation.type";
...
export const fetchFederationDetails = async (
    ...
    try {
        ...
        console.log('the config details are ', details);
